...
class PokedexesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokedex" do
    assert_difference('Pokedex.count') do
      post pokedexes_url, params: { pokedex: { category: @pokedex.category, name: @pokedex.name, type: @pokedex.type } }
    end
  ...
  test "should update pokedex" do
    patch pokedex_url(@pokedex), params: { pokedex: { category: @pokedex.category, name: @pokedex.name, type: @pokedex.type } }
